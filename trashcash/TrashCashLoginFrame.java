...
public class TrashCashLoginFrame extends JFrame{
    ...
    ImageIcon Icon = new ImageIcon("Image/TrashCashLogo.png");
    
    int desiredWidth = 900; // Set your desired width
    int desiredHeight = 660; // Set your desired height
    ImageIcon Background = resizeImageIcon("Image/trashCashBG.jpg", desiredWidth, desiredHeight);
   ...
   public static ImageIcon resizeImageIcon(String imagePath, int width, int height) {
    ...
    public JPanel rightPanel() {
     ...
     // New Account? Register here
        ...
        username.setFont(new Font("Segoe UI", Font.PLAIN, 16)); // Set font size
        username.setText("Enter username");

        // Add placeholder text for password field
        password.setForeground(Color.GREEN);
        password.setFont(new Font("Segoe UI", Font.PLAIN, 16)); // Set font size
    ...
    password.addFocusListener(new FocusAdapter() {
        ...
        public void focusGained(FocusEvent e) {
            if (String.valueOf(password.getPassword()).equals("Enter password")) {
                password.setText("");
                password.setEchoChar('*'); // Set back to password mode
